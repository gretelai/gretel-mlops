...
Follow these steps to utilize the MLOps pipelines with Gretel Synthetic data across different cloud platforms. 
...
- [Run Pipeline in AWS SageMaker](https://github.com/gretelai/gretel-mlops/blob/main/src/gretel_mlops/aws/sagemaker/run_pipeline.ipynb)
...
- [Run Pipeline in Google Cloud Vertex AI](https://github.com/gretelai/gretel-mlops/blob/main/src/gretel_mlops/gcp/vertexai/run_pipeline.ipynb)
...
- [Run Pipeline in Azure AI](https://github.com/gretelai/gretel-mlops/blob/main/src/gretel_mlops/azure/azureai/run_pipeline.ipynb)

Select a dataset from the `config` folder and follow the detailed guidance provided in each notebook to integrate Gretel Synthetic data into your ML workflows effectively.
